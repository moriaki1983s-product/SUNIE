...
導入に、別途、外部エンジンや外部サービスなしで、  
ローカル環境・ローカルネットワークで動作が完結し、  
「GitHubクローン」と「pip install」をするだけで、  
誰でも、即、簡単に実行して試せることを目指します。
...
## SUNIE-Studentのディレクトリ構造についての説明




## SUNIE-Teacherのディレクトリ構造についての説明
...
## SUNIE-Studentの使い方の説明




## SUNIE-Teacherの使い方の説明
