...
# 独自のモジュールをインポートする.
import modules.utilities.graphic as utils_graphic
import modules.utilities.simulation as utils_simulation
...
class SimUnit:
    ...
    def __new__(cls, *args, **kwargs):
        if not cls._instance:
            cls._instance = super(SimUnit, cls).__new__(cls, *args, **kwargs)
